import 'package:flutter_decision_making/ahp/data/desicion_making_repository_impl.dart';
...
class MockAhpHelper extends AhpHelper {
  int _counter = 0;
...
void main() {
  late DecisionMakingRepositoryImpl repo;
  late MockAhpHelper mockHelper;

  setUp(() {
    mockHelper = MockAhpHelper();
    repo = DecisionMakingRepositoryImpl(helper: mockHelper);
  });
  ...
  group('identification', () {
    test('assigns unique IDs if null or empty and validates uniqueness',
      ...
      final criteria = <Criteria>[
        Criteria(id: null, name: 'C1'),
        Criteria(id: '', name: 'C2'),
      ];
      final alternatives = <Alternative>[
        Alternative(id: null, name: 'A1'),
        Alternative(id: '', name: 'A2'),
      ];
    ...
    test('throws if criteria empty', () async {
      expect(() => repo.identification([], [Alternative(id: 'a1', name: 'A1')]),
          throwsArgumentError);
    });

    test('throws if alternative empty', () async {
      expect(() => repo.identification([Criteria(id: 'c1', name: 'C1')], []),
          throwsArgumentError);
    });

    test('throws if duplicate IDs found', () async {
      final criteria = [
        Criteria(id: 'dup', name: 'C1'),
        Criteria(id: 'dup', name: 'C2'),
      ];
      final alternatives = [
        Alternative(id: 'a1', name: 'A1'),
      ];
  ...
  group('generateHierarchy', () {
    test('generates hierarchy with correct mapping', () async {
      final criteria = [
        Criteria(id: 'c1', name: 'C1'),
        Criteria(id: 'c2', name: 'C2'),
      ];
      final alternatives = [
        Alternative(id: 'a1', name: 'A1'),
        Alternative(id: 'a2', name: 'A2'),
      ];
  ...
  group('generateResultPairwiseMatrixCriteria', () {
    ...
    test('throws if items not found', () async {
      final criteria = [Criteria(id: 'c1', name: 'C1')];
      final inputs = [
        PairwiseComparisonInput<Criteria>(
  ...
  group('generateResultPairwiseMatrixAlternative', () {
    test('creates matrix for alternatives with inputs', () async {
      ...
      final criteria = Criteria(name: 'A');
  ...
  group('getFinalScore', () {
    test('calculates final score correctly and sets consistency flags and note',
        () async {
      final alternatives = [
        Alternative(id: 'a1', name: 'Alternative 1'),
        Alternative(id: 'a2', name: 'Alternative 2'),
      ];
